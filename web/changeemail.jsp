...
<html>
    ...
    <head>
      ...
      function fod()
         ...
         function checknew()
         {
             var newem=document.getElementById('newemail').value;
             if(newem.length==0)
             {
                 document.getElementById('newemaildiv').innerHTML="Please enter new email!";
             }
             else
             {
                    document.getElementById('newemaildiv').innerHTML="";
             }             
         }
         function proceed()
         {
             ...
             {  
                 ...
                 m1.open("GET","checkmailserv?email="+newem,true);
             ...
             if(m1.readyState==4)
                        {
                            ...
                            if(str==1)
                                document.getElementById('newemaildiv').innerHTML="Email already associated with an account!";
                         
                             else
                             {
                                 location="oldpassconfirm.jsp";
                             }
        
                        }
                    else
                        {
                        document.getElementById('loaddiv').innerHTML="<img src='pics/load1.gif'/>";
                        }
         }
    ...
    <body >
        ...
        <table id="noop" width="1352" height="450" border="0">
          <tr>
            <td><div id="mydiv1">
              <table width="774" border="0" align="center" id="noop11">
                <tr>
                  <th width="386" height="43" scope="col">Enter new email&nbsp;
<input name="newemail" type="text" id="newemail" size="50" onblur="checknew()">
                  <div style=" font-size:15px; color: darkgreen;" id="newemaildiv"></div>
                  </th>
                
                </tr>
                
                <tr>
                  <td><input type="button" name="b1" id="b1" value="       Continue       "  onclick="proceed()"><div id="loadiv"></div></td>
