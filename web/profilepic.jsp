...
//content in new file
                ...
                String str=getServletContext().getRealPath("userdata");
                String str1=(String)session.getAttribute("sob");
                str=str+"\\"+str1+"\\dpp";
                String path=str+"\\"+session.getAttribute("fname");
                  session.setAttribute("pp",path);  
 ...
 upload the file by the name of:</b>
                                            <%response.sendRedirect("home.jsp"); %></td></tr></table> <%
                }
%>